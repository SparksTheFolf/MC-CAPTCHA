...
public class AdvancedLicense {
	...
	Main.Java (onEnable Method):
     ...
     Config.yml:
		 ...
		 License: '' # Key Example: XXXX-XXXX-XXXX-XXXX
	*/
	...
	public boolean register() {
		...
		if (vt == ValidationType.VALID) {
			log(1, "License valid!");
			log(1, "Thank you for having a valid license! :)");
			log(0, "[]==========[MWCA License-System]==========[]");
			return true;
		} else {
			log(1, "License is NOT valid!");
			log(1, "Failed as a result of " + vt.toString());
			log(1, "Please Use a vaild Key, or recheck your key! (Key Example: XXXX-XXXX-XXXX-XXXX)");
