...
public class inventory {
    ...
    public static void CPAInvis(Player player) {
        ...
        if (captcha.CAPTCHA_random_num == 0) {
        ...
        if (captcha.CAPTCHA_random_num == 1) {
            CPAInventory = Bukkit.createInventory(null, 9, ChatColor.BLACK + "Complete the CAPTCHA");
            GREEN = new ItemStack(Material.GREEN_CONCRETE);
            GREENMeta = GREEN.getItemMeta();
            GREENMeta.setDisplayName(ChatColor.GRAY + "CHOOSE THE NON-SAME COLOR");
        ...
        if (captcha.CAPTCHA_random_num == 2) {
            CPAInventory = Bukkit.createInventory(null, 9, ChatColor.BLACK + "Complete the CAPTCHA");
            GREEN = new ItemStack(Material.GREEN_CONCRETE);
            GREENMeta = GREEN.getItemMeta();
            GREENMeta.setDisplayName(ChatColor.GRAY + "CHOOSE THE NON-SAME COLOR");
        ...
        if (captcha.CAPTCHA_random_num == 3) {
            CPAInventory = Bukkit.createInventory(null, 9, ChatColor.BLACK + "Complete the CAPTCHA");
            GREEN = new ItemStack(Material.GREEN_CONCRETE);
            GREENMeta = GREEN.getItemMeta();
            GREENMeta.setDisplayName(ChatColor.GRAY + "CHOOSE THE NON-SAME COLOR");
        ...
        if (captcha.CAPTCHA_random_num == 4) {
            CPAInventory = Bukkit.createInventory(null, 9, ChatColor.BLACK + "Complete the CAPTCHA");
            GREEN = new ItemStack(Material.GREEN_CONCRETE);
            GREENMeta = GREEN.getItemMeta();
            GREENMeta.setDisplayName(ChatColor.GRAY + "CHOOSE THE NON-SAME COLOR");
        ...
        if (captcha.CAPTCHA_random_num == 5) {
            CPAInventory = Bukkit.createInventory(null, 9, ChatColor.BLACK + "Complete the CAPTCHA");
            GREEN = new ItemStack(Material.GREEN_CONCRETE);
            GREENMeta = GREEN.getItemMeta();
            GREENMeta.setDisplayName(ChatColor.GRAY + "CHOOSE THE NON-SAME COLOR");
        ...
        if (captcha.CAPTCHA_random_num == 6) {
            CPAInventory = Bukkit.createInventory(null, 9, ChatColor.BLACK + "Complete the CAPTCHA");
            GREEN = new ItemStack(Material.GREEN_CONCRETE);
            GREENMeta = GREEN.getItemMeta();
            GREENMeta.setDisplayName(ChatColor.GRAY + "CHOOSE THE NON-SAME COLOR");
        ...
        if (captcha.CAPTCHA_random_num == 7) {
            CPAInventory = Bukkit.createInventory(null, 9, ChatColor.BLACK + "Complete the CAPTCHA");
            GREEN = new ItemStack(Material.GREEN_CONCRETE);
            GREENMeta = GREEN.getItemMeta();
            GREENMeta.setDisplayName(ChatColor.GRAY + "CHOOSE THE NON-SAME COLOR");
        ...
        if (captcha.CAPTCHA_random_num == 8) {
            CPAInventory = Bukkit.createInventory(null, 9, ChatColor.BLACK + "Complete the CAPTCHA");
            GREEN = new ItemStack(Material.GREEN_CONCRETE);
            GREENMeta = GREEN.getItemMeta();
            GREENMeta.setDisplayName(ChatColor.GRAY + "CHOOSE THE NON-SAME COLOR");
